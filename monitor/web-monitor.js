...
var r = require("node-fetch"),
  t = (function () {
    function o(n) {
      var o = n.logUrl;
      if (!o) throw new Error("请传递要记录数据的路由~");
      this.logUrl = o;
    }
    return (
      (o.prototype.sendToAnalytics = function (o, t, e, i) {
        var l = this.logUrl;
...
module.exports = function (n) {
  void 0 === n && (n = {});
  var o = n.logUrl;
  if (!o) throw new Error("Web系统系统监控平台，初始化未传递logUrl");
