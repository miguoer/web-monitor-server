...
var t = function () {
    ...
    return r.prototype.sendToAnalytics = function (r, t, e, i) {
        var l = this.logUrl;
        i && (l = i), console.log("路由", l), console.log("typeof body", typeof t);
